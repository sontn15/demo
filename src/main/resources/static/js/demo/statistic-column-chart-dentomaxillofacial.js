$(document).ready(function () {
    ...
    $("#dentoMaxillofacial").change(function (event) {
    ...
    function getStatisticInsideMedicalType(type, typeShow) {
        $.ajax({
            url: `/admin/statistic-dentomaxillofacial/${type}`,
    ...
    function drawChart(typeShow, year, viewCounts) {
        Highcharts.chart('container-bar-dentoMaxillofacial', {
            chart: {
                type: 'column',
                styledMode: true
            },
            ...
            yAxis: [{
                ...
                title: {
                    text: 'Số lượng hồ sơ bệnh răng, hàm, mặt ' + typeShow
                }
            }],
            series: [{
                name: 'Số lượng',
